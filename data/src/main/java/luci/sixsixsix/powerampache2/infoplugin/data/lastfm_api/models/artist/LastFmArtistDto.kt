...
import luci.sixsixsix.powerampache2.infoplugin.data.lastfm_api.models.album.sanitizeDescription
import luci.sixsixsix.powerampache2.infoplugin.data.lastfm_api.models.toSimilarArtist
...
fun LastFmArtistDto.toPluginArtistData(
    ...
    language = "",
    imageUrl = parseImage(artist?.image?.last()?.text),
    year = "",
    url = artist?.url ?: "",
